CLASS zcl_rap100_gen_data_969 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_969 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA:
      group_id   TYPE string VALUE '969',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrav969.
*    DELETE FROM zrap100_dtrav###.

    "insert travel demo data
    INSERT zrap100_atrav969 FROM (
        SELECT
