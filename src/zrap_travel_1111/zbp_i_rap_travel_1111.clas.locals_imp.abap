...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_features.
    ...
    READ ENTITIES OF zi_rap_travel_1111 IN LOCAL MODE
      ENTITY Travel
    ...
    result =
      VALUE #(
        FOR travel IN travels
          LET is_create_mode = COND #( WHEN travel-%is_draft <> '00'
                                       THEN if_abap_behv=>fc-o-disabled
                                       ELSE if_abap_behv=>fc-o-enabled  )

              is_accepted =   COND #( WHEN travel-TravelStatus = travel_status-accepted
                                      THEN if_abap_behv=>fc-o-disabled
                                      WHEN is_create_mode = if_abap_behv=>fc-o-disabled
                                      THEN if_abap_behv=>fc-o-disabled
                                      ELSE if_abap_behv=>fc-o-enabled  )
  ...
  METHOD acceptTravel.
    ...
    MODIFY ENTITIES OF zi_rap_travel_1111 IN LOCAL MODE
      ENTITY Travel
         UPDATE
           FIELDS ( TravelStatus Keterangan )
  ...
  METHOD validateAgency.
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-AgencyID IS INITIAL OR NOT line_exists( agencies_db[ agency_id = travel-AgencyID ] ).
        ...
        APPEND VALUE #( %tky        = travel-%tky
                        %state_area = 'VALIDATE_AGENCY'
                        %msg        = NEW zcm_rap_1111(
                                          severity = if_abap_behv_message=>severity-error
                                          textid   = zcm_rap_1111=>agency_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-CustomerID IS INITIAL OR NOT line_exists( customers_db[ customer_id = travel-CustomerID ] ).
        ...
        APPEND VALUE #(  %tky        = travel-%tky
                         ...
                         %msg        = NEW zcm_rap_1111(
                                           severity   = if_abap_behv_message=>severity-error
                                           textid     = zcm_rap_1111=>customer_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-EndDate < travel-BeginDate.
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_1111(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zcm_rap_1111=>date_interval
      ...
      ELSEIF travel-BeginDate < cl_abap_context_info=>get_system_date( ).
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_1111(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zcm_rap_1111=>begin_date_before_system_date
                                                 begindate = travel-BeginDate )
  ...
  METHOD is_create_granted.
    AUTHORITY-CHECK OBJECT 'ZOSTAT1111'
      ID 'ZOSTAT1111' DUMMY
      ID 'ACTVT' FIELD '01'.
  ...
  METHOD is_update_granted.
    IF has_before_image = abap_true.
      AUTHORITY-CHECK OBJECT 'ZOSTAT1111'
        ID 'ZOSTAT1111' FIELD overall_status
        ID 'ACTVT' FIELD '02'.
    ELSE.
      AUTHORITY-CHECK OBJECT 'ZOSTAT1111'
        ID 'ZOSTAT1111' DUMMY
      ...
      IF is_update_requested = abap_true.
        ...
        IF has_before_image = abap_true.
          ...
          IF update_granted = abap_false.
            APPEND VALUE #( %tky        = travel-%tky
                            %msg        = NEW zcm_rap_1111( severity = if_abap_behv_message=>severity-error
                                                            textid   = zcm_rap_1111=>unauthorized )
                          ) TO reported-travel.
          ENDIF.
...
*CLASS lhc_ZI_RAP_Booking_1111 DEFINITION INHERITING FROM cl_abap_behavior_handler.
*  PRIVATE SECTION.
*
*    METHODS calculateBookingID FOR DETERMINE ON MODIFY
*      IMPORTING keys FOR ZI_RAP_Booking_1111~calculateBookingID.
*
*    METHODS calculateTotalPrice FOR DETERMINE ON MODIFY
*      IMPORTING keys FOR ZI_RAP_Booking_1111~calculateTotalPrice.
*
*ENDCLASS.
*
*CLASS lhc_ZI_RAP_Booking_1111 IMPLEMENTATION.
*
